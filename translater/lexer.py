...
class noToken:
    def __init__(self, nonterminal, list):
...
# CONST_ID
TokenTypeDict = dict(PI=Token(TokenType.CONST_ID, "PI", sympy.pi),
                     E=Token(TokenType.CONST_ID, "E", sympy.E),
                     ...
                     SIN=Token(TokenType.FUNC, "SIN", 0.0, sympy.sin),
                     COS=Token(TokenType.FUNC, "COS", 0.0, sympy.cos),
                     TAN=Token(TokenType.FUNC, "TAN", 0.0, sympy.tan),
                     LN=Token(TokenType.FUNC, "LN", 0.0, sympy.log),
                     EXP=Token(TokenType.FUNC, "EXP", 0.0, sympy.exp),
                     SQRT=Token(TokenType.FUNC, "SQRT", 0.0, sympy.sqrt),
